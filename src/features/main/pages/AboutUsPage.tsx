...
const AboutUsPage: React.FC = () => {
  ...
  const cards = [
    { title: "Our Mission", content: "To make mental health support accessible, effective, and personalized for everyone." },
    { title: "Our Vision", content: "A world where mental well-being is prioritized and supported in every workplace and community." },
    { title: "Our Values", content: "Compassion, innovation, accessibility, and excellence in everything we do." },
    { title: "Our Team", content: "Experienced professionals dedicated to transforming mental health care." },
    { title: "Our Impact", content: "Making a difference in thousands of lives through our comprehensive services." },
    { title: "Our Approach", content: "Combining cutting-edge technology with human-centered care." }
  ];
  ...
  return (
    <PageBackground backgroundImage="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=2071&auto=format&fit=crop">
      ...
      >
        ...
        >
          At Refill Health, we're committed to revolutionizing mental health care through innovative solutions, compassionate service, and evidence-based practices. Our team of experts works tirelessly to make mental health support accessible to everyone.
        </motion.p>
