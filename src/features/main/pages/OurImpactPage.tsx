...
const OurImpactPage: React.FC = () => {
  ...
  return (
    <PageBackground backgroundImage="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=2084&auto=format&fit=crop">
      <motion.div
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center w-full">
          {[
            {
              title: "Lives Changed",
              content: "Thousands of individuals have found support and improved their mental well-being through our platform."
            },
            {
              title: "Organizations Served",
              content: "Partnering with leading organizations to create healthier, more productive workplaces."
            },
            {
              title: "Community Impact",
              content: "Building stronger communities through accessible mental health support and education."
            },
            {
              title: "Future Vision",
              content: "Continuously expanding our reach and impact to make mental health support available to all."
            }
          ].map((card, index) => (
            <motion.div
              key={card.title}
